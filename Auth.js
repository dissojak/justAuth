  ...
  const authSubmitHandler = async (event) => {
    ...
    if (isLoginMode) {
      try {
        ...
        auth.login(res.user.id, res.user.username, res.user.isAdmin, res.ban);
      } catch (e) {}
    } else {
      try {
        const res = await sendRequest(
          ...
          <div id="login_content">
            ...
            <div id="login_form">
              ...
              {isLoginMode ? "LOGIN" : "SIGNUP"}
                  ...
                  <h4 class="inder_form font">
                    <em>Need and account ?</em> Create one
                  </h4>
                </>
              </form>
            </div>
        ...
        <div id="page_signup">
          <div id="signup_content">
              ...
              <form onSubmit={authSubmitHandler}>
                <>
                  ...
                  <div className="signup-login_Buttons">
                    ...
                    />
                    <h4 className="inder_form font">
                      <em>Connect to you account ?</em> Login from here
                    </h4>
                  </div>
                </>
              </form>
            ...
            <div id="sign_up_paragraphe">
              <button className="AdminButton" onClick={showAdminFormHandler}>
              <img src="elements/logo_white.png" alt="" className="mg" />
              </button>
              {showImage ? (
                <div className="image-container">
                <ImageUpload center id="imageUpload" onInput={inputHandler} />
                {isAdminForm && (
                // <input type="password" id="AdminCode" name="AdminCode" placeholder="Enter Admin Code" class="Admin-code-input" />
